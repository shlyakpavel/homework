...
'Порядковый номер первого отрицательного элемента массива не менее порядкового номера первого минимума или между ними отсутствую значения. В связи с этим решений нет.'
    );
End.
